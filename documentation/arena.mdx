---
title: 'Chatbot Arena'
description: 'Chatbot Arena is an LLM benchmark platform featuring anonymous, randomized battles'
icon: 'sword'
---

We invite the entire community to join this benchmarking effort by contributing your votes and models, available at https://chat.lmsys.org.
